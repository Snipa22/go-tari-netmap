...
func newTestStore(t *testing.T) storage.Store {
	...
	if _, err := pool.Exec(ctx, "TRUNCATE TABLE node_health, peer_edge_observations, node_addresses, pending_submissions, pending_wallet_submissions, nodes CASCADE"); err != nil {
		pool.Close()
